...
#' @export
#'
#' @examples DfMSE <- best_forecast_by_MSE(DF, data, f, DFError, trainStart, ts_data, vended_labor)
...
best_forecast_by_MSE <- function(DF, data, f, DFError, trainStart, ts_data, names){
